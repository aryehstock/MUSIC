...
df_NHI_re_dc[2,3] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_AC == 0)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_AC == 0)))
df_NHI_re_dc[2,4] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_AC == 1)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_AC == 1)))
df_NHI_re_dc[2,5] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_AC == 2)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_AC == 2)))
df_NHI_re_dc[2,6] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_AC == 3)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_AC == 3)))
df_NHI_re_dc[2,7] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_AC == 4)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_AC == 4)))
...
df_NHI_re_dc[2,8] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_TC == 0)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_TC == 0)))
df_NHI_re_dc[2,9] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_TC == 1)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_TC == 1)))
df_NHI_re_dc[2,10] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_TC == 2)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_TC == 2)))
df_NHI_re_dc[2,11] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_TC == 3)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_TC == 3)))
df_NHI_re_dc[2,12] <- sum(((q1$NHI_max_RE == 1) & (q1$NHI_max_TC == 4)) | ((q1$NHI_max_DC == 1) & (q1$NHI_max_TC == 4)))
...
```{r}
df_NHI_re_dc <- df_NHI_re_dc |> 
  mutate(max_ac_nhi_0_f = paste0(format(round(percent_max_ac_nhi_0 * 100, 2), nsmall = 2), "% (", max_ac_nhi_0, ")")) |> 
  mutate(max_ac_nhi_1_f = paste0(format(round(percent_max_ac_nhi_1 * 100, 2), nsmall = 2), "% (", max_ac_nhi_1, ")")) |> 
  mutate(max_ac_nhi_2_f = paste0(format(round(percent_max_ac_nhi_2 * 100, 2), nsmall = 2), "% (", max_ac_nhi_2, ")")) |> 
  mutate(max_ac_nhi_3_f = paste0(format(round(percent_max_ac_nhi_3 * 100, 2), nsmall = 2), "% (", max_ac_nhi_3, ")")) |> 
  mutate(max_ac_nhi_4_f = paste0(format(round(percent_max_ac_nhi_4 * 100, 2), nsmall = 2), "% (", max_ac_nhi_4, ")")) |> 
  mutate(max_tc_nhi_0_f = paste0(format(round(percent_max_tc_nhi_0 * 100, 2), nsmall = 2), "% (", max_tc_nhi_0, ")")) |> 
  mutate(max_tc_nhi_1_f = paste0(format(round(percent_max_tc_nhi_1 * 100, 2), nsmall = 2), "% (", max_tc_nhi_1, ")")) |> 
  mutate(max_tc_nhi_2_f = paste0(format(round(percent_max_tc_nhi_2 * 100, 2), nsmall = 2), "% (", max_tc_nhi_2, ")")) |> 
  mutate(max_tc_nhi_3_f = paste0(format(round(percent_max_tc_nhi_3 * 100, 2), nsmall = 2), "% (", max_tc_nhi_3, ")")) |> 
  mutate(max_tc_nhi_4_f = paste0(format(round(percent_max_tc_nhi_4 * 100, 2), nsmall = 2), "% (", max_tc_nhi_4, ")")) 
```
