...
```{r, eval= FALSE}
NHI_rec_ac_per |> 
  gtsave(filename = "output_tables/ac_per.png")

NHI_rec_ac |> 
  gtsave(filename = "output_tables/ac_num.png")

NHI_rec_tc_per |> 
  gtsave(filename = "output_tables/tc_per.png")

NHI_rec_tc |> 
  gtsave(filename = "output_tables/tc_num.png")

NHI_rec_dc_per |> 
  gtsave(filename = "output_tables/dc_per.png")

NHI_rec_dc |> 
  gtsave(filename = "output_tables/dc_num.png")
```
...
```{r, echo=FALSE}
NHI_r_atd_per |> 
  gtsave(filename = "output_tables/nhi_r_atd.png")
```
